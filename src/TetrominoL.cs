...
namespace TetrisClone
{
    ...
    {
        #region Constructors
        public TetrominoL(int startRow, int startCol, Point2D basePosition, int cellWidth) : base(startRow, startCol, basePosition, cellWidth)
        {
            _background = SwinGame.RGBColor(255, 153, 0);
