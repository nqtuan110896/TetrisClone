...
namespace TetrisClone
{
    ...
    {
        #region Constructors
        public TetrominoJ(int startRow, int startCol, Point2D basePosition, int cellWidth) : base(startRow, startCol, basePosition, cellWidth)
        {
            _background = SwinGame.RGBColor(0, 0, 255);
